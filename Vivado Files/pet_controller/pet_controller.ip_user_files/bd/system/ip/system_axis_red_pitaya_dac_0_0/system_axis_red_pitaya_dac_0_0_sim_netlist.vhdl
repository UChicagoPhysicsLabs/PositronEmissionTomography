...
--               c:/FPGA/FromScratch/FromScratch.gen/sources_1/bd/system/ip/system_axis_red_pitaya_dac_0_0/system_axis_red_pitaya_dac_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of system_axis_red_pitaya_dac_0_0_axis_red_pitaya_dac is
  ...
  signal int_rst_reg : STD_LOGIC_VECTOR ( 1 to 1 );
  signal \int_rst_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \int_rst_reg_reg_n_0_[0]\ : STD_LOGIC;
...
\int_rst_reg[0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => locked,
      I1 => s_axis_tvalid,
      O => \int_rst_reg[0]_i_1_n_0\
    );
\int_rst_reg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => '1',
      D => \int_rst_reg[0]_i_1_n_0\,
      Q => \int_rst_reg_reg_n_0_[0]\,
      R => '0'
    );
\int_rst_reg_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => aclk,
      CE => '1',
      D => \int_rst_reg_reg_n_0_[0]\,
      Q => int_rst_reg(1),
      R => '0'
    );
end STRUCTURE;
...
entity system_axis_red_pitaya_dac_0_0 is
  ...
  attribute IP_DEFINITION_SOURCE of system_axis_red_pitaya_dac_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_axis_red_pitaya_dac_0_0 : entity is "axis_red_pitaya_dac,Vivado 2024.1";
...
architecture STRUCTURE of system_axis_red_pitaya_dac_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME aclk, ASSOCIATED_BUSIF s_axis, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s_axis_tvalid : signal is "XIL_INTERFACENAME s_axis, TDATA_NUM_BYTES 4, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 0, FREQ_HZ 125000000, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of wrt_clk : signal is "xilinx.com:signal:clock:1.0 wrt_clk CLK";
  attribute X_INTERFACE_PARAMETER of wrt_clk : signal is "XIL_INTERFACENAME wrt_clk, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /clk_wiz_0_clk_out1, INSERT_VIP 0";
