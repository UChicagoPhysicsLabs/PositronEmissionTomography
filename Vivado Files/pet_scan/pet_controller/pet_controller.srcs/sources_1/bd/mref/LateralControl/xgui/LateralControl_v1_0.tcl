...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "reset_position" -parent ${Page_0}
...
proc update_PARAM_VALUE.reset_position { PARAM_VALUE.reset_position } {
	# Procedure called to update reset_position when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.reset_position { PARAM_VALUE.reset_position } {
	# Procedure called to validate reset_position
	return true
}
...
proc update_MODELPARAM_VALUE.reset_position { MODELPARAM_VALUE.reset_position PARAM_VALUE.reset_position } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.reset_position}] ${MODELPARAM_VALUE.reset_position}
}
