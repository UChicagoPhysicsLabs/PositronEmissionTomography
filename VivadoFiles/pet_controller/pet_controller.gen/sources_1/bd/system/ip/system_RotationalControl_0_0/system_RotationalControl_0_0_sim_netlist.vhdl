...
--               c:/FPGA/FromScratch/FromScratch.gen/sources_1/bd/system/ip/system_RotationalControl_0_0/system_RotationalControl_0_0_sim_netlist.vhdl
...
entity system_RotationalControl_0_0_RotationalControl is
  port (
    ...
    control_signal_in : in STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
...
architecture STRUCTURE of system_RotationalControl_0_0_RotationalControl is
  ...
  signal \state_next1_inferred__2/i__carry__1_n_0\ : STD_LOGIC;
  signal \state_next1_inferred__2/i__carry__1_n_1\ : STD_LOGIC;
  signal \state_next1_inferred__2/i__carry__1_n_2\ : STD_LOGIC;
  signal \state_next1_inferred__2/i__carry__1_n_3\ : STD_LOGIC;
  signal \state_next1_inferred__2/i__carry__2_n_0\ : STD_LOGIC;
  signal \state_next1_inferred__2/i__carry__2_n_1\ : STD_LOGIC;
  signal \state_next1_inferred__2/i__carry__2_n_2\ : STD_LOGIC;
  signal \state_next1_inferred__2/i__carry__2_n_3\ : STD_LOGIC;
  ...
  signal \state_next[2]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \NLW_state_next1_inferred__2/i__carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM of \reset_state[1]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \reset_state[1]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \reset_state[1]_i_5\ : label is "soft_lutpair3";
  attribute COMPARATOR_THRESHOLD : integer;
  attribute COMPARATOR_THRESHOLD of \state_next1_inferred__2/i__carry\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \state_next1_inferred__2/i__carry__0\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \state_next1_inferred__2/i__carry__1\ : label is 11;
  attribute COMPARATOR_THRESHOLD of \state_next1_inferred__2/i__carry__2\ : label is 11;
  attribute SOFT_HLUTNM of \state_next[0]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \state_next[0]_i_3\ : label is "soft_lutpair1";
begin
...
current_dir_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
internal_motor_state_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AA8A0080"
    )
        port map (
...
internal_motor_state_i_11: unisim.vcomponents.LUT6
    generic map(
...
internal_motor_state_i_12: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
internal_motor_state_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000007"
    )
        port map (
...
internal_motor_state_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
internal_motor_state_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\reset_state[1]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\reset_state[1]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
\state_next1_inferred__2/i__carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \state_next1_inferred__2/i__carry__1_n_0\,
      CO(2) => \state_next1_inferred__2/i__carry__1_n_1\,
...
\state_next1_inferred__2/i__carry__2\: unisim.vcomponents.CARRY4
     port map (
      CI => \state_next1_inferred__2/i__carry__1_n_0\,
      CO(3) => \state_next1_inferred__2/i__carry__2_n_0\,
      CO(2) => \state_next1_inferred__2/i__carry__2_n_1\,
      CO(1) => \state_next1_inferred__2/i__carry__2_n_2\,
      CO(0) => \state_next1_inferred__2/i__carry__2_n_3\,
      CYINIT => '0',
      DI(3) => \i__carry__2_i_1_n_0\,
      DI(2) => \i__carry__2_i_2_n_0\,
      DI(1) => \i__carry__2_i_3_n_0\,
      DI(0) => \i__carry__2_i_4_n_0\,
      O(3 downto 0) => \NLW_state_next1_inferred__2/i__carry__2_O_UNCONNECTED\(3 downto 0),
...
\state_next[0]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FCF7FFF7"
    )
        port map (
...
entity system_RotationalControl_0_0 is
  ...
  attribute X_CORE_INFO of system_RotationalControl_0_0 : entity is "RotationalControl,Vivado 2024.1";
end system_RotationalControl_0_0;

architecture STRUCTURE of system_RotationalControl_0_0 is
  signal \<const0>\ : STD_LOGIC;
  signal \^motor_state\ : STD_LOGIC_VECTOR ( 5 downto 0 );
...
begin
  ...
  motor_state(2 downto 0) <= \^motor_state\(2 downto 0);
...
inst: entity work.system_RotationalControl_0_0_RotationalControl
     port map (
      Q(2 downto 0) => \^motor_state\(2 downto 0),
      clk => clk,
      control_signal_in(3 downto 0) => control_signal_in(3 downto 0),
