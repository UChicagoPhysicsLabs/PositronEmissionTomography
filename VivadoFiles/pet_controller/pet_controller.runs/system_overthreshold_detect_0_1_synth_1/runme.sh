...
HD_PWD='C:/FPGA/FromScratch/FromScratch.runs/system_overthreshold_detect_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_overthreshold_detect_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_overthreshold_detect_0_1.tcl
