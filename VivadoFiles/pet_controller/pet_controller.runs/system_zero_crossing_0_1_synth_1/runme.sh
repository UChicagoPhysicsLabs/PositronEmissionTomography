...
HD_PWD='C:/FPGA/FromScratch/FromScratch.runs/system_zero_crossing_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_zero_crossing_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_zero_crossing_0_1.tcl
