...
HD_PWD='C:/FPGA/pet_scan/pet_scan.runs/system_axi_gpio_0_10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_0_10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_0_10.tcl
