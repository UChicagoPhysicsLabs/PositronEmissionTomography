...
HD_PWD='C:/FPGA/FromScratch/FromScratch.runs/system_axi_gpio_0_9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_gpio_0_9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_gpio_0_9.tcl
