...
HD_PWD='C:/FPGA/pet_scan/pet_scan.runs/system_Debouncer_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_Debouncer_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_Debouncer_0_2.tcl
