...
HD_PWD='C:/FPGA/FromScratch/FromScratch.runs/system_pulse_extender_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pulse_extender_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pulse_extender_0_0.tcl
